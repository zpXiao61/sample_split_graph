...
g2_output_tensors = ['concat:0','concat_1:0']
g3_input_tensors = ['Preprocessor/map/TensorArrayStack_1/TensorArrayGatherV3:0','concat:0','concat_1:0']
...
g3_input_values = [g1_output_values[1]]
